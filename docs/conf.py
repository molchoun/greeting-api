...
"""
greeting-api documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'greeting-api',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/https://github.com/molchoun/greeting-api",
...
#
# html_title = 'greeting-api v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Greeting API',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'greeting_api'),
                os.path.join(root_path, 'greeting_api/migrations')])
