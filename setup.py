#!/usr/bin/env python
"""
Package metadata for greeting_api.
"""
import os
import re
import sys
...
VERSION = get_version('greeting_api', '__init__.py')
...
setup(
    ...
    author='Arsen Movsisian',
    author_email='oscm@openedx.org',
    url='https://github.com/https://github.com/molchoun/greeting-api',
    packages=find_packages(
        include=['greeting_api', 'greeting_api.*'],
        exclude=["*tests"],
    ),
